...
Allowed JSON shape:
{
  "intent": "RESUME_AUTOMATION" | "PAUSE_AUTOMATION" | "SHOW_STATUS" | "SHOW_DAILY_REPORT" | "CHANGE_DAILY_LIMIT" | "CHANGE_MIN_MARGIN" | "FIND_PRODUCTS" | "ANALYZE_PRODUCTS" | "CREATE_LISTING_DRAFTS" | "PUBLISH_SAFE_DRAFTS_SANDBOX" | "SHOW_FAILED_TASKS" | "UPDATE_BLOCKED_CATEGORY" | "UPDATE_BLOCKED_BRAND" | "CHANGE_APPROVAL_MODE" | "EXPLAIN_SYSTEM" | "ASK_CLARIFICATION" | "UNKNOWN",
  "confidence": number,
...
- "minimum profit/margin 20 faiz olsun" => CHANGE_MIN_MARGIN with min_margin_percentage 20.
...
- Normal settings changes such as pause, resume, status, min margin, daily limit, blocked category, and blocked brand can execute directly when clear.
